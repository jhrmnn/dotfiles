...
" New functionality {{{
" -----------------
call minpac#add('AndrewRadev/linediff.vim')         " diffing ranges, key: <Leader>ldf
...
call minpac#add('junegunn/goyo.vim')                " distraction-free vim, key: <Leader>go
call minpac#add('junegunn/limelight.vim')           " dim surrounding paragrpahs
call minpac#add('junegunn/vim-easy-align')          " easy table alignment
call minpac#add('justinmk/vim-sneak')               " additional movements
...
call minpac#add('neomake/neomake')                  " async make
